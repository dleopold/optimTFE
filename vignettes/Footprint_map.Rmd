...
Use the 'add_auxiliary_layers' function argument in the create_interactive_map function
to add context to the conservation footprint interactive maps. The image below shows a conservation footprint with 
