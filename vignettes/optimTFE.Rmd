...
other input files as desired. View the 
...
# and clipped to include # only units for a given species if the suitability
# value is >= 0.1.
...
If >100,000 solutions were generated, and depending on computer RAM, subsetting solutions
before creating many summary statistics may reduce run time.
...
sol44_suit_values <- solution_suit_values(44, sample_sols100, file.path("./output", "solutions.meta"))
...
sol44_selected_spp_suit <- selected_spp_suit(solution_number, sample_sols100, file.path("./output", "solutions.meta"))
```
