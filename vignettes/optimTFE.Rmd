...
# Now we will merge to get all summary data and solution info, and spatial data. This could get
...
Plot a solution and show where it falls compared to all solutions, and the top 10%
of all solutions, for a given metric.
...
# Metric we are evaluating is native habitat denoted as 'good_hab_mean_pct.'
...
plot_my_metric
```
We have more advanced tools for visually exploring solutions further:
Explore_footprints vignette for exploring metrics across all solutions; and
Footprint_map vignette for exploring target and landscape metrics of a single
solution.
