...
## Introduction
####optimTFE is a spatial conservation prioritization (SCP) tool created to help conservation
...
# sample_sols100 <- read.csv(file.path("./inst", "extdata", "output", "solutions.csv"))
...
write.csv(all_sols_metrics, "sample_sols100_metrics.csv")
