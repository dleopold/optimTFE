...
write.csv(all_sols_metrics, file.path(dir, "output", "sample_sols100_metrics.csv" ))
...
```{r Plot distribution of solutions across metrics compared to a single solution, echo=FALSE, fig.width=11, fig.height=8, fig.show='asis'}
