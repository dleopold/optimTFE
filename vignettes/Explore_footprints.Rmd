...
In this vignette we show how we can evaluate tradeoffs across all conservation footprints using metrics useful to conservation practitioners.  
...
or native habitat, etc. The specific set of criteria considered in the analysis is project specific, with the examples provided representing a set of criteria identified as valuable metrics to be used in footprint selection in our particular case study.
...
order. This is an important feature as some metrics min or max values may be desired (e.g., invaded vs native habitat area per PU).
